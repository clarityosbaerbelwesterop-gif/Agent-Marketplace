 ...
 * stay limited to the first-party registry in `lib/connectors/registry.ts`.
 */
...
export const MCP_REGISTRY_SOURCE = {
  ...
  publicName: "Öffentliches MCP-Verzeichnis",
  ...
  publicNotes:
    "Nur Katalogmetadaten. Es wird nichts installiert oder verbunden.",
};

export const GITHUB_TOPIC_SOURCE = {
  id: "github_topic" as const,
  name: "GitHub repository topics",
  publicName: "Öffentliche Code-Kataloge",
  ...
  publicNotes:
    "Suche in öffentlichen Repositories nach MCP-Themen. Kein Installer, keine Zugangsdaten in der Oberfläche.",
};
